...
"[project]/apps/portal/src/screens/components/drivers-table/columns.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/portal/src/screens/components/drivers-table/utils/placeholders.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/portal/src/screens/components/drivers-table/editable-table-cell.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$portal$2f$src$2f$screens$2f$components$2f$drivers$2d$table$2f$utils$2f$placeholders$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/portal/src/screens/components/drivers-table/utils/placeholders.ts [app-client] (ecmascript)");
;
...
const EditableTableCell = /*#__PURE__*/ _s(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["memo"](_c = _s(function EditableTableCell({ value, field, isEditing, onFocus, onEdit, onBlur, onChange, onDoubleClick, error, isMissing = false }) {
        ...
        "EditableTableCell.EditableTableCell.useEffect": ()=>{
            if (isEditing && field.type === 'dropdown' && selectTriggerRef.current) {
                ...
                const timeoutId = setTimeout({
                    "EditableTableCell.EditableTableCell.useEffect.timeoutId": ()=>{
                        selectTriggerRef.current?.click();
                    }
                }["EditableTableCell.EditableTableCell.useEffect.timeoutId"], 50);
                return ({
                    "EditableTableCell.EditableTableCell.useEffect": ()=>clearTimeout(timeoutId)
                })["EditableTableCell.EditableTableCell.useEffect"];
            }
        }
    }["EditableTableCell.EditableTableCell.useEffect"], [
    ...
    if (!isEditing) {
        ...
        const placeholder = isEmpty ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$portal$2f$src$2f$screens$2f$components$2f$drivers$2d$table$2f$utils$2f$placeholders$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDisplayPlaceholder"])(field, field.required) : null;
    ...
    if (field.type === 'text') {
        ...
        const placeholder = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$portal$2f$src$2f$screens$2f$components$2f$drivers$2d$table$2f$utils$2f$placeholders$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getEditPlaceholder"])(field);
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
"[project]/apps/portal/src/screens/components/drivers-table/use-keyboard-navigation.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useKeyboardNavigation({ driverCount, fieldCount, onCellChange, onAddDriver }) {
    ...
    const moveToCell = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useKeyboardNavigation.useCallback[moveToCell]": (driverIndex, fieldIndex)=>{
                ...
                "useKeyboardNavigation.useCallback[moveToCell]": ()=>{
                    ...
                    if (cellElement) {
                        ...
                        if (focusableElement) {
                            ...
                            }["useKeyboardNavigation.useCallback[moveToCell]"], 20);
                        }
...
"[project]/apps/portal/src/screens/components/drivers-table/mvr-suggestions.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function MVRSuggestions({ mvrDrivers, existingDrivers, onAddDriver, isLoading = false }) {
    ...
    const filteredMVRDrivers = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "MVRSuggestions.useMemo[filteredMVRDrivers]": ()=>{
            return mvrDrivers.filter({
                "MVRSuggestions.useMemo[filteredMVRDrivers]": (mvrDriver)=>{
                    // Check if a driver with the same name and DOB already exists
                    const exists = existingDrivers.some({
                        "MVRSuggestions.useMemo[filteredMVRDrivers].exists": (driver)=>{
                    ...
                    }["MVRSuggestions.useMemo[filteredMVRDrivers].exists"]);
                    return !exists;
                }
            }["MVRSuggestions.useMemo[filteredMVRDrivers]"]);
        }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "space-y-2",
                children: filteredMVRDrivers.map((mvrDriver, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(MVRSuggestionCard, {
                        mvrDriver: mvrDriver,
...
_s(MVRSuggestions, "G60rL/dKvaUBtliNUBrWhivuT04=");
_c = MVRSuggestions;
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                mvrDriver.confidence && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                mvrDriver.source && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    className: "text-xs text-muted-foreground",
                                    style: {
                                        fontFamily: "Inter, sans-serif"
                                    },
...
_c1 = MVRSuggestionCard;
var _c, _c1;
__turbopack_context__.k.register(_c, "MVRSuggestions");
__turbopack_context__.k.register(_c1, "MVRSuggestionCard");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/apps/portal/src/screens/components/drivers-table/validation.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/portal/src/screens/components/drivers-table/keyboard-shortcuts.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/portal/src/screens/components/drivers-table/utils/missing-data.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/portal/src/screens/components/drivers-table/drivers-table.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$portal$2f$src$2f$screens$2f$components$2f$drivers$2d$table$2f$columns$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/portal/src/screens/components/drivers-table/columns.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$portal$2f$src$2f$screens$2f$components$2f$drivers$2d$table$2f$editable$2d$table$2d$cell$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/portal/src/screens/components/drivers-table/editable-table-cell.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$portal$2f$src$2f$screens$2f$components$2f$drivers$2d$table$2f$use$2d$keyboard$2d$navigation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/portal/src/screens/components/drivers-table/use-keyboard-navigation.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$portal$2f$src$2f$screens$2f$components$2f$drivers$2d$table$2f$mvr$2d$suggestions$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/portal/src/screens/components/drivers-table/mvr-suggestions.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$portal$2f$src$2f$screens$2f$components$2f$drivers$2d$table$2f$validation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/portal/src/screens/components/drivers-table/validation.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$portal$2f$src$2f$screens$2f$components$2f$drivers$2d$table$2f$keyboard$2d$shortcuts$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/portal/src/screens/components/drivers-table/keyboard-shortcuts.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$portal$2f$src$2f$screens$2f$components$2f$drivers$2d$table$2f$utils$2f$missing$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/portal/src/screens/components/drivers-table/utils/missing-data.ts [app-client] (ecmascript)");
...
function DriversTable({ drivers: initialDrivers, fields = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$portal$2f$src$2f$screens$2f$components$2f$drivers$2d$table$2f$columns$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DRIVER_FIELDS"] }) {
    _s();
    const { quoteData, updateDrivers, saveQuote } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$portal$2f$src$2f$app$2f$quote$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuote"])();
    // Use quote data if available, otherwise use initialDrivers prop, otherwise use sample data
    const defaultDrivers = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "DriversTable.useMemo[defaultDrivers]": ()=>{
    ...
    const [drivers, setDrivers] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"](defaultDrivers);
    const [newDriverIds, setNewDriverIds] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"](new Set());
    const [mvrDrivers] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"](SAMPLE_MVR_DRIVERS);
    ...
    const [isLoadingMVR, setIsLoadingMVR] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"](false);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$portal$2f$src$2f$shared$2f$hooks$2f$use$2d$auto$2d$save$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAutoSave"])({
        data: drivers,
        saveFn: {
            "DriversTable.useAutoSave": async (data)=>{
                updateDrivers(data);
                await saveQuote();
            }
        }["DriversTable.useAutoSave"],
        debounceMs: 2000,
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"]({
        "DriversTable.useEffect": ()=>{
            ...
            drivers.forEach({
                "DriversTable.useEffect": (driver, driverIndex)=>{
                    fields.forEach({
                        "DriversTable.useEffect": (field)=>{
                            if (field.required) {
                                const value = driver[field.id];
    ...
    const visibleFields = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "DriversTable.useMemo[visibleFields]": ()=>{
            if (!showMissingOnly) return fields;
            return fields.filter({
                "DriversTable.useMemo[visibleFields]": (field)=>{
                    // Check if any driver has missing data for this field
                    return drivers.some({
                        "DriversTable.useMemo[visibleFields]": (driver, driverIndex)=>{
                            if (!field.required) return false;
    ...
    const getOriginalFieldIndex = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "DriversTable.useCallback[getOriginalFieldIndex]": (visibleIndex)=>{
            if (!showMissingOnly) return visibleIndex;
            const field = visibleFields[visibleIndex];
            return fields.findIndex({
                "DriversTable.useCallback[getOriginalFieldIndex]": (f)=>f.id === field.id
            }["DriversTable.useCallback[getOriginalFieldIndex]"]);
        }
    }["DriversTable.useCallback[getOriginalFieldIndex]"], [
        showMissingOnly,
        visibleFields,
    ...
    const getVisibleFieldIndex = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "DriversTable.useCallback[getVisibleFieldIndex]": (originalIndex)=>{
            if (!showMissingOnly) return originalIndex;
            const field = fields[originalIndex];
            return visibleFields.findIndex({
                "DriversTable.useCallback[getVisibleFieldIndex]": (f)=>f.id === field.id
            }["DriversTable.useCallback[getVisibleFieldIndex]"]);
        }
    }["DriversTable.useCallback[getVisibleFieldIndex]"], [
        showMissingOnly,
        visibleFields,
    ...
    const handleAddDriverRef = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"](null);
    ...
    const findNextVisibleField = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "DriversTable.useCallback[findNextVisibleField]": (originalIndex)=>{
            if (!showMissingOnly) {
    ...
    }["DriversTable.useCallback[findNextVisibleField]"], [
        showMissingOnly,
        fields.length,
    ...
    const findPreviousVisibleField = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "DriversTable.useCallback[findPreviousVisibleField]": (originalIndex)=>{
            if (!showMissingOnly) {
    ...
    }["DriversTable.useCallback[findPreviousVisibleField]"], [
        showMissingOnly,
        getVisibleFieldIndex
    ]);
    // Keyboard navigation hook - keep using original field count for bounds checking
    const { activeCell, editingCell, moveToCell, startEditing, stopEditing, containerRef } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$portal$2f$src$2f$screens$2f$components$2f$drivers$2d$table$2f$use$2d$keyboard$2d$navigation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useKeyboardNavigation"])({
        driverCount: drivers.length,
        fieldCount: fields.length,
        onAddDriver: {
            "DriversTable.useKeyboardNavigation": ()=>handleAddDriverRef.current?.()
        }["DriversTable.useKeyboardNavigation"]
    });
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"]({
        "DriversTable.useEffect": ()=>{
            const handleKeyDown = {
                "DriversTable.useEffect.handleKeyDown": (event)=>{
                    ...
                    if ((event.ctrlKey || event.metaKey) && event.key.toLowerCase() === 'm' && !isInput && !isSelect) {
                        ...
                        setShowMissingOnly({
                            "DriversTable.useEffect.handleKeyDown": (prev)=>!prev
                        }["DriversTable.useEffect.handleKeyDown"]);
                    }
                }
            }["DriversTable.useEffect.handleKeyDown"];
            window.addEventListener("keydown", handleKeyDown);
            return ({
                "DriversTable.useEffect": ()=>window.removeEventListener("keydown", handleKeyDown)
            })["DriversTable.useEffect"];
        }
    }["DriversTable.useEffect"], []);
    const handleCellChange = (driverIndex, fieldIndex, value)=>{
        ...
        const error = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$portal$2f$src$2f$screens$2f$components$2f$drivers$2d$table$2f$validation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["validateCellValue"])(value, field);
        const errorKey = `${driverIndex}-${field.id}`;
    ...
    const handleAddDriver = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "DriversTable.useCallback[handleAddDriver]": ()=>{
            const newDriver = {
                id: `driver-${Date.now()}`,
                firstName: '',
                lastName: '',
            ...
            setDrivers({
                "DriversTable.useCallback[handleAddDriver]": (prev)=>[
                        ...prev,
                        newDriver
                    ]
            }["DriversTable.useCallback[handleAddDriver]"]);
            setNewDriverIds({
                "DriversTable.useCallback[handleAddDriver]": (prev)=>new Set(prev).add(newDriver.id)
            }["DriversTable.useCallback[handleAddDriver]"]);
            ...
            }["DriversTable.useCallback[handleAddDriver]"], 100);
        }
    }["DriversTable.useCallback[handleAddDriver]"], [
        drivers.length,
        moveToCell,
    ...
    const getDriverBadges = (driver, index)=>{
        ...
        const missingCount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$portal$2f$src$2f$screens$2f$components$2f$drivers$2d$table$2f$utils$2f$missing$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getRowMissingCount"])(driver, fields);
        if (missingCount > 0) {
            badges.push({
                type: 'incomplete',
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: drivers.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        drivers.map((driver, driverIndex)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    visibleFields.length === 0 && showMissingOnly ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            "aria-rowindex": visibleIndex + 2,
                                            "aria-colindex": driverIndex + 2,
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$portal$2f$src$2f$screens$2f$components$2f$drivers$2d$table$2f$editable$2d$table$2d$cell$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EditableTableCell"], {
                                                value: cellValue,
                                                field: field,
                                                isEditing: isEditing,
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$portal$2f$src$2f$screens$2f$components$2f$drivers$2d$table$2f$mvr$2d$suggestions$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MVRSuggestions"], {
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$portal$2f$src$2f$screens$2f$components$2f$drivers$2d$table$2f$keyboard$2d$shortcuts$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["KeyboardShortcuts"], {}, void 0, false, {
                                        fileName: "[project]/apps/portal/src/screens/components/drivers-table/drivers-table.tsx",
                                        lineNumber: 794,
                                        columnNumber: 19
                                    }, this)
...
_s(DriversTable, "SWXtbS6v/XB6c6tTVoSRrnKGDM8=", false, function() {
    return [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$portal$2f$src$2f$screens$2f$components$2f$drivers$2d$table$2f$use$2d$keyboard$2d$navigation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useKeyboardNavigation"]
    ];
});
_c = DriversTable;
var _c;
__turbopack_context__.k.register(_c, "DriversTable");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=apps_portal_src_screens_components_drivers-table_5d44ebb6._.js.map